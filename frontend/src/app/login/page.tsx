  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gh-canvas">
      <div className="w-full max-w-sm">
        ...
        <div className="bg-gh-canvas-subtle border border-gh-border rounded-lg p-6 mb-4">
          <a
            href="/api/auth/google"
            className="inline-flex items-center justify-center gap-3 w-full px-4 py-3 bg-white text-gray-900 font-medium rounded-lg hover:bg-gray-100 transition-colors"
          >
        ...
        <div className="relative mb-4">
          ...
          <div className="relative flex justify-center text-xs">
            <span className="bg-gh-canvas px-2 text-gh-text-secondary">or</span>
          </div>
        </div>
